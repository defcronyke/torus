/*  Copyright (c) 2021 Jeremy Carter <jeremy@jeremycarter.ca>,
    ...
    https://github.com/jackaudio/jack2/blob/1ab3445e65ec2bfc1ba8562984822616e03fb9fe/example-clients/capture_client.c
...
int jack2_capture_client_main(int argc, char *argv[]) {
  jack_thread_info_t thread_info;
	...
	while ((jack2_client_running == 1) && ((c = getopt_long (argc, argv, optstring, long_options, &longopt_index)) != -1)) {
		switch (c) {
		case 1:
